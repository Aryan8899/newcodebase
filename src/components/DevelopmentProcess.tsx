...
const steps = [
  {
    ...
    desc: 'Describe what you need, set your budget, and choose a deadline.',
    color: '#3b82f6',
    bg: '#eff6ff',
  },
  {
    ...
    desc: 'Verified taskers send competitive bids for your task.',
    color: '#e91e8c',
    bg: '#fdf2f8',
  },
  {
    ...
    desc: 'Compare ratings, reviews, and prices before selecting.',
    color: '#06b6d4',
    bg: '#ecfeff',
  },
  {
    ...
    desc: 'Payment is held safely in escrow until completion.',
    color: '#f59e0b',
    bg: '#fffbeb',
  },
  {
    ...
    desc: 'Approve the task and rate your experience.',
    color: '#10b981',
    bg: '#ecfdf5',
  },
];
