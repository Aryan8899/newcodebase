        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <p className="animate-item text-gray-700 leading-relaxed">
              ...
              With real-time updates, competitive offers, and secure escrow payments, we ensure transparency and trust at every step. <span className="font-bold">Mobrib</span> is a leading Mobile App, Software Development and Web Development company helping global businesses to bring digital transformation. Being a true technological companion, mobrib InfoSystem helps startups to enterprise-level businesses to be the industry leaders.
            </p>
